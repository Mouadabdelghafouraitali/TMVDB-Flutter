...
class _PopularState extends State<Popular> {
  ...
  _getContent() {
    return Container(
      ...
      future: FutureHelper.getPopularMovies(),
  ...
  _itemMovie(AsyncSnapshot<Movies> snapshot, int index) {
    return Padding(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
            return MovieDetails(
                ...
                heroId: '${snapshot.data.results[index].id}popular');
          }));
        },
        child: Hero(
          tag: '${snapshot.data.results[index].id}popular',
          child: Card(
            elevation: 0.3,
            child: Row(
              children: <Widget>[
  ...
  _getDetails(AsyncSnapshot<Movies> snapshot, int index) {
    return Expanded(
      child: Container(
        width: 200.0,
        height: 190.0,
  ...
  _subDetails(AsyncSnapshot<Movies> snapshot, int index) {
    return Expanded(
      child: Container(
        height: 150.0,
